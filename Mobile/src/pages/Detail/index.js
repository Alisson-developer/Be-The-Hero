...
export default function Detail(){
    ...
    function sandMail(){
        MailComposer.composeAsync({
            subject: `Herói do caso: ${incident.title}`, //assunto do e-mail
            recipients: [incident.email], // destinatário do e-mail
            body: message, // conteúdo do e-mail(mensagem)
        })
    }

    function sandWhastapp(){
        ...
        <View style={styles.container}>
            ...
            <View style={styles.contactBox}>
                ...
                <View style={styles.actions}>
                    <TouchableOpacity style={styles.action} onPress={sandWhastapp}>
